...
public class Landscape implements GLEventListener, KeyListener, MouseListener{
		 ...
		 * 
		 * Bonnes pratiques:
		 * - gl.Begin() ... gl.glEnd(); : faire un minimum d'appel, id斬lement un par it屍ation. (gain de 50% � 100% ici)
		 * - gl.glCullFace(GL.GL_FRONT); ... gl.glEnable(GL.GL_CULL_FACE); : si la scene le permet, r仕uit le nb de polyg a afficher.
		 * - TRIANGLE SPLIT permet de r仕uire le nombre d'appels � OpenGL (gl.begin et end)
